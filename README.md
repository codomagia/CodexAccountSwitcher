...
Windows-утилита для сохранения и быстрого переключения аккаунтов в приложении ChatGPT Codex.

Программа позволяет сохранять авторизации под понятными именами, безопасно переключаться между ними в один клик, запускать ChatGPT Codex и создавать ярлыки на рабочем столе для каждого аккаунта или для нового входа.

Поддерживаются **как официальная версия из [Microsoft Store](https://apps.microsoft.com/detail/9nxq8fg885bb) / установщика, так и любые Portable-сборки** ChatGPT Codex.
...
- **Автоматическое обнаружение:** утилита сама видит активные процессы ChatGPT Codex в системе и блокирует операции во время работы, защищая профили от повреждения.
- **100% автономность:** утилита работает локально, без телеметрии и без отправки данных на сторонние серверы.

## Как пользоваться

1. Закройте ChatGPT Codex, если он запущен.
